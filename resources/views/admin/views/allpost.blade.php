                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item" style="font-family: 'Times New Roman', Times, serif;"><a
                                        href="admin/">Home</a></li>
                                <li class="breadcrumb-item active"
                                    style="font-family: 'Times New Roman', Times, serif;">All Post</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="example1" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                @foreach ($posts as $k => $data)
                                    <tr>
                                        <td style="font-family: 'Times New Roman', Times, serif;">{{ $data->id }}
                                        </td>
                                        <td style="font-family: 'Times New Roman', Times, serif;">{{ $data->title }}
                                        </td>

                                        <td style="font-family: 'Times New Roman', Times, serif;">
                                            {!! substr(strip_tags($data->body), 0, 50) !!}...</td>

                                        <td><img src="{{ URL::to($data->image) }}" width="50"></td>

                                        <td class="project-actions text-right">
                                            <a class="btn btn-primary btn-sm" target="_new"
                                                href="<?= Url('/') ?>/blog/{{ $data->slug }}"
                                            ...
                                            <form id="delete-post{{ $data->id }}" method="POST"
                                                action="{{ route('postdelete', $data->id) }}"
                                                style="font-family: 'Times New Roman', Times, serif;">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
                                                ...
                                                <a class="btn btn-danger btn-sm"
                                                    onclick="document.getElementById('delete-post{{ $data->id }}').submit();"
